...
# Define the version of the EPHI dataset being used
EPHI_version = "2024-03-18"

# Initialize empty data frames for storing site and data descriptions
sitef = NULL
data_descf = NULL
...
for(pays in c("Costa-Rica","Ecuador","Brazil")){
	...
	#merge data and phenological indices
	dim(tab)
	...
	#export empirical networks
	fwrite(emp_net,paste0(here("data_zenodo"),"empirical_networks_",pays,".txt"))

	#EXPORT DATASET for each country
